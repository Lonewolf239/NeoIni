...
- Attribute‑based mapping & source generator (1.7+) — [detailed guide](./docs/ATTRIBUTE-MAPPING.md)
- Hot Reload (1.7.1+) — [usage & caveats](./docs/HOT-RELOAD.md)
- Human‑editable INI mode (1.7.2+) — [experimental mode](./docs/HUMAN-MODE.md)
