...
Currently, only the latest release (**1.6.1-pre1**) is supported with security updates and patches.
...
|---------|-----------|-------|
| **1.6.1-pre1** | :white_check_mark: | **Pre-release** / Preview build, not recommended for production |
