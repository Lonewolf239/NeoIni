...
Please note that **all previous versions** (`< 1.5.8.2`) are deprecated. They are no longer available for download as they contain known bugs or were incomplete pre-release builds that did not reach final stability standards.

| Version | Supported | Notes |
|---------|-----------|-------|
| **1.6** | :white_check_mark: | **Current Stable Release** |
| **1.5.8.2** | :white_check_mark: | **Stable Release** |
| < 1.5.8.2 | :x: | Incomplete / Buggy / Deprecated |
