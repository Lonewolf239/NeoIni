...
namespace NeoIni
{
    public partial class NeoIniDocument
    {
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="provider"/> or <paramref name="encryptionProvider"/> is <c>null</c>.</exception>
        ...
        /// Thrown when <paramref name="options"/> has <see cref="NeoIniOptions.UseShielding"/> set to <c>true</c>;
        /// shielding cannot be combined with Human Mode.
        /// </exception>
        /// <remarks>
        ...
        {
            if (options?.UseShielding == true) throw new ModeConflictException();
