...
Раньше автоматический ключ выводился из имени пользователя, имени машины и домена — эти значения часто видны по сети или легко угадываются, поэтому файл, который лишь *выглядел* привязанным к машине, на практике можно было расшифровать где угодно, если атакующий мог воспроизвести эту строку. С версии **3.5** ключ выводится из:
