...
|---------|--------|---------|
| 3.4.2 | **CSR** | Security-патчи + исправления багов |
| 3.4.1 | LSR | Доступна для скачивания |
| 3.4 | LSR | Доступна для скачивания |
| 3.3 | LSR | Доступна для скачивания |
| 3.2.2 | LSR | Доступна для скачивания |
| 3.2.1 | LSR | Доступна для скачивания |
| 3.2 | LSR | Доступна для скачивания |
| 3.1 | LSR | Доступна для скачивания |
| 3.0 | LSR | Доступна для скачивания |
| 2.x, 1.x и старше | **DSR** | Неполные, багованные или устаревшие версии. Если вы используете версии старше 2.0, обновитесь до 3.2.1. |
