...
| Документация | XML-doc на каждом публичном члене. `./README-RU.md` с быстрым стартом, синхронизированный с последним релизом. Полный гайд по миграции при каждом мажорном обновлении. |
