...
| 3.x | 🔵 Under consideration | **Поддержка потоковых провайдеров**: возможность чтения/записи больших конфигураций инкрементально, без загрузки всего набора данных в память. |
| 3.x | 🔵 Under consideration | **Memory‑mapped I/O**: опциональное использование memory‑mapped файлов для очень больших INI‑файлов, чтобы повысить производительность и снизить потребление памяти. |
