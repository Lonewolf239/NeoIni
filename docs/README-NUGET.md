📖 **[Documentation & Wiki](https://github.com/Lonewolf239/NeoIni/wiki)** — detailed guides, API reference, and examples
...
- Pluggable encryption (2.0+) — [custom encryption providers](https://github.com/Lonewolf239/NeoIni/blob/main/docs/ENCRYPTION-PROVIDER.md)
