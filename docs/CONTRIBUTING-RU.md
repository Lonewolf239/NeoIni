...
- **Версию NeoIni** (текущая: `3.4.3`) и **версию .NET**.
...
Отправляя код, вы соглашаетесь лицензировать свой вклад на условиях [GPLv3](https://github.com/Lonewolf239/NeoIni/blob/main/LICENSE).
