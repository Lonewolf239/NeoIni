...
|---------|--------|-------------|
| 1.7 | ✅ Released | Object mapping API (Get<T>, Set<T>) |
| 1.7.1 | ✅ Released | Hot‑reload via file watcher. |
| 1.7.2 | ✅ Released | Human‑editable INI mode. |
| 1.7.3 | 🕓 Planned | Pluggable provider abstraction (INeoIniProvider). |
